...
python3 "/home/${username}/flash-tv-scripts/python_scripts/set_ext_RTC_and_save_start_date.py" "/home/${username}/data/${participantID}_data/${participantID}_start_date.txt"
