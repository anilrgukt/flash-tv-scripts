...
sed -i "s/XXX/$deviceID/g" ~/flash-tv-scripts/services/daily-reboot.service
sed -i "s/123/$familyID/g" ~/flash-tv-scripts/services/daily-reboot.service
sed -i "s/XXX/$deviceID/g" ~/flash-tv-scripts/services/daily_reboot.sh
sed -i "s/123/$familyID/g" ~/flash-tv-scripts/services/daily_reboot.sh
