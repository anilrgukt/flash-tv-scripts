...
from flash.gaze_estimation import FLASHGazeEstimator, eval_thrshld, get_lims, load_limits
...
while True:
    ...
    if tc_face is not None:
        ...
        result_img, result_img2 = draw_gz(
            img_np1080, o1, tc_bbx, os.path.join(gz_res_path, frame_name), gz_label=gaze_est[0], write_img=write_image, scale=[480, 854]
        )
