        ...
        while True:
            ...
            if not q.empty():
                ...
                if any(frame_bbox_ls):
                    ...
                    write_line_rot = (
                        [timestamp, str(frame_counts[3]).zfill(6), num_faces, int(tc_present)] + gaze_data1_rot + [tc_angle] + tc_pos + [label]
                    )
                    write_line_reg = (
                        [timestamp, str(frame_counts[3]).zfill(6), num_faces, int(tc_present)] + gaze_data2 + [tc_angle] + tc_pos + [label]
                    )
